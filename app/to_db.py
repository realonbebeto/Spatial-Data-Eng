...
# Read DHS
dhs = pd.read_csv("~/Documents/kazispaces/desrc/Spatial-Data-Eng/data/uga_dhs_2016.csv")
...
dhs["adult_radio_regular"] = dhs.adult_radio_regular.apply(lambda x: boolify(x))
